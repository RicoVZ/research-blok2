...
\ \\\hl{Using Yara, a tool using signatures to recognize data structures in binary  data, it will determined if a malware configuration is present in the memory dump or not} \cite{roberston-ioc}.
