...
\textbf{Idle}\\
Analyses in this group start to delay the execution after being started by making the process sleep. The memory does not contain any \Gls{configuration data} during the length of these analyses.
